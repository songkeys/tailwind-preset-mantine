...
test("default imports and theme output do not duplicate the autogenerated header", () => {
	const css =
		generateDefaultImports() +
		generateTheme(undefined, { includeComment: false });
	const matches =
		css.match(
			/\/\*\* This file is autogenerated by the script\. Do not edit it manually\. \*\//g,
		) ?? [];
